...
####################CODIGO NUEVO DEFINITIVO PARA CVES IOT#################################################
########################################################################################
#################################VARIABLES##############################################
...
#ABRO DOCUMENTO
with open('List_CVE_2023.json','r',encoding='utf-8') as f:
...
for h in range (0,cve_items_aux.shape[1]):
    ...
    values.insert(2,"4.0")
    values.insert(3,"2023-04-11T16:44Z")
...
df_excel2.to_excel('cves_iot_2023.xlsx')
