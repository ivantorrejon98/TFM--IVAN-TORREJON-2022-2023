...
ejemplo_dir = 'IBM\VULNERABILIDADES\IOT\FICHEROS IOT/'
contenido = os.listdir(ejemplo_dir)
for fichero in contenido:
    with open("IBM\VULNERABILIDADES\IOT\FICHEROS IOT/"+fichero,'r',encoding="utf-8") as f:
...
df_excel2.to_excel('vulnerabilidades_ibm_iot_2023.xlsx')
