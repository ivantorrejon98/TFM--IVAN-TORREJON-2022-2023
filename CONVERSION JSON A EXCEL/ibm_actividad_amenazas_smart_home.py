...
###################################IBM\THREAT ACTIVITY REPORT\IBM/IOT
import pandas as pd
import json
import math
import os
...
final=0
columns=["type","labels","name","published","x_com_ibm_short_description","x_com_ibm_iris_tags","id","created","modified","object_refs","definition_type","valid_from","pattern","x_com_ibm_html_content","x_com_ibm_source_pdf","x_com_ibm_source","description"]
...
ejemplo_dir = 'IBM/THREAT ACTIVITY REPORT/SMART HOME/FICHEROS SMART HOME/'
contenido = os.listdir(ejemplo_dir)
for fichero in contenido:
    with open("IBM/THREAT ACTIVITY REPORT/SMART HOME/FICHEROS SMART HOME/"+fichero,'r',encoding="utf-8") as f:
...
df_excel=pd.DataFrame(valuesdef,columns[0:18])
df_excel2=df_excel.transpose()
df_excel2.to_excel('ibm_threat_activity_report_smarthome_2023_v2.xlsx')
