...
final=0
columns=["type","labels","name","published","x_com_ibm_short_description","x_com_ibm_iris_tags","id","created","modified","object_refs","definition_type","x_com_ibm_html_content","x_com_ibm_source_pdf","x_com_ibm_source","description"]
...
ejemplo_dir = 'IBM/GRUPO DE AMENAZAS\FICHEROS PERFIL GRUPO DE AMENAZAS/'
contenido = os.listdir(ejemplo_dir)
for fichero in contenido:
    with open("IBM/GRUPO DE AMENAZAS\FICHEROS PERFIL GRUPO DE AMENAZAS/"+fichero,'r',encoding="utf-8") as f:
...
df_excel=pd.DataFrame(valuesdef,columns[0:16])
df_excel2=df_excel.transpose()
df_excel2.to_excel('ibm_grupo_amenazas_v2.xlsx')