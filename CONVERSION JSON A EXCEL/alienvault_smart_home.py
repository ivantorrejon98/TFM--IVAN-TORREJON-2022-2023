...
ejemplo_dir = 'ALIENVAULT/SMART HOME/FICHERO SMART HOME ALIENVAULT/'
contenido = os.listdir(ejemplo_dir)
for fichero in contenido:
    with open("ALIENVAULT/SMART HOME/FICHERO SMART HOME ALIENVAULT/"+fichero,'r',encoding="utf-8") as f:
...
df_excel2.to_excel('alienvault_smart_home_2023.xlsx')