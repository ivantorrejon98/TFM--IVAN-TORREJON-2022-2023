...
ejemplo_dir = 'IBM/THREAT ACTIVITY REPORT/IOT/FICHEROS IOT/'
contenido = os.listdir(ejemplo_dir)
for fichero in contenido:
    with open("IBM/THREAT ACTIVITY REPORT/IOT/FICHEROS IOT/"+fichero,'r',encoding="utf-8") as f:
...
df_excel2.to_excel('ibm_threat_activity_report_iot_2023_v2.xlsx')