...
ejemplo_dir = 'IBM/ANALISIS MALICIOSOS/FICHEROS ANALISIS MALICIOSOS SMART HOME/'
contenido = os.listdir(ejemplo_dir)
for fichero in contenido:
    with open("IBM/ANALISIS MALICIOSOS/FICHEROS ANALISIS MALICIOSOS SMART HOME/"+fichero,'r',encoding="utf-8") as f:
...
df_excel2.to_excel('ibm_analisis_maliciosos_smarthome_2023.xlsx')
