...
print("**************************ESTADÍSTICAS FECHA DE ULTIMA MODIFICACION CPES COINCIDENTES PARA HIJOS DE NODOS DE CVES Y CPE********************************")
print("\n")
print("LA FECHA DE ULTIMA MODIFICACION EN "+str(count_lastmodidate_2023_cpe_iot)+" CPES ES EN 2023\n")
print("LA FECHA DE ULTIMA MODIFICACION EN "+str(count_lastmodidate_2022_cpe_iot)+" CPES ES EN 2022 \n")
print("LA FECHA DE ULTIMA MODIFICACION EN "+str(count_lastmodidate_2021_cpe_iot)+" CPES ES EN 2021 \n")
print("LA FECHA DE ULTIMA MODIFICACION EN "+str(count_lastmodidate_2020_cpe_iot)+" CPES ES EN 2020 \n")
print("LA FECHA DE ULTIMA MODIFICACION EN "+str(count_lastmodidate_2019_cpe_iot)+" CPES ES EN 2019 \n")
print("LA FECHA DE ULTIMA MODIFICACION EN "+str(count_lastmodidate_2018_cpe_iot)+"  CPES ES ANTERIOR A 2019 \n")
print("\n")
print("**************************PORCENTAJE FECHA DE ULTIMA MODIFICACION CPES COINCIDENTES PARA HIJOS DE NODOS DE CVES Y CPET********************************")
print("\n")
print("EL "+str(float(((count_lastmodidate_2023_cpe_iot*100)/len(cpes_coinc_iotsh))))+" % DE LOS CPES FUE MODIFICADO POR ULTIMA VEZ EN 2023 \n")
print("EL "+str(float(((count_lastmodidate_2022_cpe_iot*100)/len(cpes_coinc_iotsh))))+" % DE LOS CPES FUE MODIFICADO POR ULTIMA VEZ EN 2022 \n")
print("EL "+str(float(((count_lastmodidate_2021_cpe_iot*100)/len(cpes_coinc_iotsh))))+" % DE LOS CPES FUE MODIFICADO POR ULTIMA VEZ EN 2021 \n")
print("EL "+str(float(((count_lastmodidate_2020_cpe_iot*100)/len(cpes_coinc_iotsh))))+" % DE LOS CPES FUE MODIFICADO POR ULTIMA VEZ EN 2020 \n")
print("EL "+str(float(((count_lastmodidate_2019_cpe_iot*100)/len(cpes_coinc_iotsh))))+" % DE LOS CPES FUE MODIFICADO POR ULTIMA VEZ EN 2019 \n")
print("EL "+str(float(((count_lastmodidate_2018_cpe_iot*100)/len(cpes_coinc_iotsh))))+" % DE LOS CPES FUE MODIFICADO POR ULTIMA VEZ ANTES DE 2019 \n")
print("\n")