...
cves=['CVE-2023-23379','CVE-2023-25017','CVE-2023-25018','CVE-2023-0847','CVE-2022-33005']
...
#Variables para almacenar distintos elementos del VECTOR CVSSV3 segun la BASE SCORE
...
print("\n")
print(" DE UN TOTAL DE "+str(len(cves))+" VULNERABILIDADES , LAS ESTADISTICAS DE LOS ELEMENTOS DEL VECTOR CVSSV3 SEGUN SEVERIDAD SON LAS SIGUIENTES:  \n")
print("\n")
...
print("\n")
print("\n")
print("********************PORCENTAJES ELEMENTOS VECTOR CVSSV3-BASE SCORE CVSSV3 SEGUN SEVERIDAD********************")
print("\n")        
            
print("\n")
print(" DE UN TOTAL DE "+str(len(cves))+" VULNERABILIDADES ,  LOS PORCENTAJES DE LOS ELEMENTOS DEL VECTOR CVSSV3 SEGUN SEVERIDAD SON LOS SIGUIENTES:   \n")
print("\n")
if(cvssV3_BASE_severity_critical_iot>0):
